 ...
 *
 * @deprecated  As of release 1.3.2, replaced by <a href="https://github.com/Knotx/knotx-data-bridge/blob/master/adapter-http/src/main/java/io/knotx/databridge/http/common/configuration/HttpDataSourceSettings.java">HttpDataSourceSettings</a>
