...
public class HttpServiceAdapterImpl extends AbstractAdapterProxy<HttpAdapterConfiguration> {

  private HttpClientFacade httpClientFacade;

  public HttpServiceAdapterImpl(Vertx vertx, HttpAdapterConfiguration configuration) {
    super(configuration);
