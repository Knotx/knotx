...
public class HttpActionAdapterImpl extends AbstractAdapterProxy<HttpAdapterConfiguration> {

  private HttpClientFacade httpClientFacade;

  public HttpActionAdapterImpl(Vertx vertx, HttpAdapterConfiguration configuration) {
    super(configuration);
