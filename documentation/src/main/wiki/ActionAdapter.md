...
An example usage of service params is presented in [[Http Service Adapter|HttpServiceAdapter#Setting-service-query-parameters]], which uses the same mechanism. 
