...
```
java -Dvertx.logger-delegate-factory-class-name=io.vertx.core.logging.SLF4JLogDelegateFactory -cp config:target/knotx-example-app-X.Y.Z-fat.jar io.vertx.core.Launcher
```
