...
- If you have custom Handlebars helpers ([See how to implement custom Handlebars helpers](https://github.com/Cognifide/knotx/wiki/TemplatingEngine#extending-handlebars-with-custom-helpers)), you can put it as JAR file here
