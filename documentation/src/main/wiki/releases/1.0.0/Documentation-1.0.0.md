...
[http://search.maven.org](http://search.maven.org/#search%7Cga%7C1%7Cg%3A%22io.knotx%22).
...
- [knotx-example-app-1.0.0.fat.jar](https://oss.sonatype.org/content/groups/public/io/knotx/knotx-example-app/1.0.0/knotx-example-app-1.0.0.fat.jar)
- [knotx-example-app-1.0.0.json](https://oss.sonatype.org/content/groups/public/io/knotx/knotx-example-app/1.0.0/knotx-example-app-1.0.0.json)
