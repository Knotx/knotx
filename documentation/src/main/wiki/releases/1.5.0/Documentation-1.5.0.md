...
- [Handlebars Knot](#handlebars-knot)
  - [How does it work?](#how-does-it-work-9)
    - [Example](#example-2)
  - [Interpolation symbol](#interpolation-symbol)
...
- [Fallback Handling](#fallback-handling)
  - [How does it work?](#how-does-it-work-16)
  - [How to configure?](#how-to-configure-13)
    - [Simple blank fallback (per snippet)](#simple-blank-fallback-per-snippet)
    - [Static markup fallback (per snippet)](#static-markup-fallback-per-snippet)
    - [Global blank fallback](#global-blank-fallback)
    - [Global fallback with custom markup](#global-fallback-with-custom-markup)
  - [How to extend?](#how-to-extend-1)
    - [Implementation guidelines, marking nodes as failed](#implementation-guidelines-marking-nodes-as-failed)
- [Logging](#logging)
