...
public class TemplateEngineTest {
  ...
  private ViewKnotConfiguration getConfig(String configFile) throws Exception {
    return new ViewKnotConfiguration(new JsonObject(FileReader.readText(configFile)));
  }
