...
/** @module knotx-fragment-assembler-js/fragment_assembler_service */
...
/**
 ...
 @memberof module:knotx-fragment-assembler-js/fragment_assembler_service
 @param configuration {Object}
 @return {FragmentAssemblerService}
 */
FragmentAssemblerService.create = function(configuration) {
  var __args = arguments;
  if (__args.length === 1 && (typeof __args[0] === 'object' && __args[0] != null)) {
    return utils.convReturnVertxGen(JFragmentAssemblerService["create(io.vertx.core.json.JsonObject)"](utils.convParamJsonObject(configuration)), FragmentAssemblerService);
  } else throw new TypeError('function invoked with invalid arguments');
};
