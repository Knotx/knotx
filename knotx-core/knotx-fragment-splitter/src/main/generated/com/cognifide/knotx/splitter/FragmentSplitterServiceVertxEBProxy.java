...
public class FragmentSplitterServiceVertxEBProxy implements FragmentSplitterService {
  ...
  public FragmentSplitterServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public FragmentSplitterServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
