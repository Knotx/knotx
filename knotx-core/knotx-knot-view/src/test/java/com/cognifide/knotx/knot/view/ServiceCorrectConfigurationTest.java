...
public class ServiceCorrectConfigurationTest {
  ...
  private ViewKnotConfiguration correctConfig;
  private ViewKnotConfiguration.ServiceMetadata expectedService;

  @Before
  public void setUp() throws Exception {
    JsonObject config = new JsonObject(FileReader.readText("service-correct.json"));
    correctConfig = new ViewKnotConfiguration(config);
  ...
  private ViewKnotConfiguration.ServiceMetadata createMockedService(String name, String address, String params, String cacheKey) {
    ViewKnotConfiguration.ServiceMetadata newService = new ViewKnotConfiguration.ServiceMetadata();
