...
import com.cognifide.knotx.knot.view.service.ServiceEngine;
import com.cognifide.knotx.knot.view.service.ServiceEntry;
...
class TemplateSnippetProcessor {
  ...
  TemplateSnippetProcessor(EventBus eventBus, ViewKnotConfiguration configuration) {
