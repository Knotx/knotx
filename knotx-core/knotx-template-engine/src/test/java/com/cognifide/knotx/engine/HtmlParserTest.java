...
public class HtmlParserTest extends AbstractKnotxConfigurationTest {
    ...
    private String EXPECTED_ONE_FRAGMENT = "<script data-api-type=\"templating\" data-uri=\"/service/mock/first.json\"\n        type=\"text/x-handlebars-template\"><h2>{{message}}</h2></script>";
