...
public class FragmentAssemblerServiceVertxEBProxy implements FragmentAssemblerService {
  ...
  public FragmentAssemblerServiceVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public FragmentAssemblerServiceVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
