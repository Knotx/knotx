...
public class SystemPropsConfiguration {
  ...
  /**
   * Update given JsonObject with the data provided in system property during Knotx start. In order
   * to provide such overrides you can use two approches: - -Dio.knotx.KnotxServer.httpPort=9999,
   * -Dio.knotx.KnotxServer.splitter.address=other-address -> this will override one property with
   * the value given after '=' - -Dio.knotx.KnotxServer.splitter=file:/aaa/bb/cc.json - this will
   * merge the given cc.json file from the field specified
   */
